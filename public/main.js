...
/* harmony import */ var _ngui_auto_complete__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ngui/auto-complete */ "./node_modules/@ngui/auto-complete/dist/index.js");
/* harmony import */ var _ngui_auto_complete__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_ngui_auto_complete__WEBPACK_IMPORTED_MODULE_15__);
...
/* harmony import */ var _services_overall_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./services/overall.service */ "./src/app/services/overall.service.ts");
/* harmony import */ var _services_individual_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./services/individual.service */ "./src/app/services/individual.service.ts");
...
var appRoutes = [
    ...
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_10__["DashboardComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_18__["AuthGuard"]] },
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_11__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_18__["AuthGuard"]] },
];
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _ngui_auto_complete__WEBPACK_IMPORTED_MODULE_15__["NguiAutoCompleteModule"],
            ],
            providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_16__["ValidateService"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_4__["FlashMessagesService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_17__["AuthService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_18__["AuthGuard"], _services_overall_service__WEBPACK_IMPORTED_MODULE_19__["OverallService"], _services_individual_service__WEBPACK_IMPORTED_MODULE_20__["IndividualService"], _services_author_service__WEBPACK_IMPORTED_MODULE_21__["AuthorService"]],
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(overallService, individualService, authorService, flashMessage, alerts) {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.overallService.getInfos(3).subscribe(function (data) {
            //console.log(data);
            for (var i = 0; i < 3; i++) {
                _this.mostRevs.push(data['mostRevisions'][i]);
                _this.leastRevs.push(data['leastRevisions'][i]);
                _this.longHis.push(data['longestHistory'][i]);
            }
            _this.shortHis.push(data['shortestHistory'][0]);
            _this.largeGP.push(data['largestGroup'][0]);
            _this.smallGP.push(data['smallestGroup'][0]);
        ...
        // Author Analytics Section *******************************************
        this.authorService.getAllUniqueAuthors().subscribe(function (data) {
            console.log(data);
            for (var i = 0; i < data['authors'].length; i++) {
                _this.authors.push(data['authors'][i]);
            }
        });
    };
    // *******************************************************************
    DashboardComponent.prototype.changeRevNums = function (num) {
        ...
        if (this.revNum < 1) {
            ...
            this.mostRevs = [];
            this.leastRevs = [];
            this.overallService.getInfos(num).subscribe(function (data) {
                //console.log(data)
                for (var i = 0; i < num; i++) {
                    _this.mostRevs.push(data['mostRevisions'][i]);
                    _this.leastRevs.push(data['leastRevisions'][i]);
        ...
        if (type == 'null') {
            ...
            if (type == 'line') {
                ...
                this.overallService.getChartData().subscribe(function (data) {
                    ...
                    _this.chart = new chart_js__WEBPACK_IMPORTED_MODULE_5__["Chart"]('chart', {
                        type: 'line',
                        data: {
                            labels: labels,
                            datasets: [
    ...
    DashboardComponent.prototype.drawArticleChart = function (type) {
        ...
        if (type == 'null') {
            ...
            if (type == 'line') {
                ...
                this.chart = new chart_js__WEBPACK_IMPORTED_MODULE_5__["Chart"]('articleChart', {
                    type: 'line',
                    data: {
                        labels: labels,
                        datasets: [
    ...
    DashboardComponent.prototype.drawArticleTop5 = function () {
        ...
        this.individualService.getArticleTop5(this.articleTitle, this.selectedTop5).subscribe(function (data) {
            ...
            _this.chart = new chart_js__WEBPACK_IMPORTED_MODULE_5__["Chart"]('articleChart', {
                type: 'line',
                data: {
                    labels: labels,
                    datasets: chartData,
    ...
    DashboardComponent.prototype.getRevsOfAuthor = function (author) {
        var _this = this;
        this.authorService.getRevsOfAuthor(this.author).subscribe(function (data) {
            console.log(data);
            for (var i = 0; i < data['length']; i++) {
                if (_this.authorTitles.indexOf(data[i]['_id']['title']) == -1) {
                    _this.authorTitles.push(data[i]['_id']['title']);
                }
            }
            //console.log(this.authorTitles)
            for (var i = 0; i < _this.authorTitles.length; i++) {
                var revNum = 0;
                var timestamp = [];
                for (var j = 0; j < data['length']; j++) {
                    if (_this.authorTitles[i] == data[j]['_id']['title']) {
                        revNum += 1;
                        timestamp.push(data[j]['_id']['timestamp']);
                    }
                }
                _this.authorArticles.push({
                    title: _this.authorTitles[i],
                    revNums: revNum,
                    timestamp: timestamp,
                    show: false
                });
    ...
    DashboardComponent.prototype.toggleDetails = function (title) {
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_overall_service__WEBPACK_IMPORTED_MODULE_1__["OverallService"],
            ...
            angular_alert_module__WEBPACK_IMPORTED_MODULE_6__["AlertsService"]])
    ], DashboardComponent);
...
module.exports = "<main role=\"main\">\n  <div class=\"jumbotron\">\n     <div class=\"container\">\n        <h1 class=\"display-3\">MEAN WikiLatic</h1>\n        <p class=\"lead\">This is a Data Analytic Web Application. The dataset contains a number of files in JSON formats storing revision histories of Wikipedia articles. The dataset was created by querying wikipedia API. The articles are selected from\n          Featured Articles.</p>\n        <p style=\"float: left\"><a class=\"btn btn-primary btn-lg\" [routerLink]=\"['/register']\" role=\"button\">Register &raquo;</a></p>\n        <p><a class=\"btn btn-default\" [routerLink]=\"['/login']\">Login</a></p>\n     </div>\n   </div>\n\n  <div class=\"container\">\n    <div class=\"row\">\n      <div class=\"col-md-4\">\n        <h2>Overall Analysis</h2>\n        <p>Overall yearly revision number distribution</p>\n        <img src=\"../../assets/images/fig1.png\" width=\"300px\" height=\"300px\">\n      </div>\n      <div class=\"col-md-4\">\n        <h2>Individual Article Analysis</h2>\n        <p>User type distribution</p>\n        <img src=\"../../assets/images/fig4.png\" width=\"300px\" height=\"300px\">\n      </div>\n      <div class=\"col-md-4\">\n        <h2>Author Analysis</h2>\n        <p>User type distribution</p>\n        <img src=\"../../assets/images/fig5.png\" width=\"300px\" height=\"300px\">\n      </div>\n    </div>\n\n    <hr>\n\n  </div> <!-- /container -->\n</main>\n\n<footer class=\"container\">\n  <p>&copy; MEAN WikiLatic 2018 Yangkai Hong</p>\n</footer>\n"
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            ...
            if (data['success'] == true) {
                _this.flashMessageService.show('You are now registered and can log in', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessageService.show('', { cssClass: 'alert-danger', timeout: 3000 });
...
var AuthorService = /** @class */ (function () {
    ...
    AuthorService.prototype.getRevsOfAuthor = function (author) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('author', author);
